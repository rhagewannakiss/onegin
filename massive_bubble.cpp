...
//     fprintf(stderr, "lenstr1, 2: %ld, %ld \n", len_str1, len_str2);
    ...
    // while (!isalpha(str1_ind_start[len_str1]) && (len_str1 < (int)strlen(len_str1))) {
    //     fprintf(stderr, "index symb %d  %d \n", str1[str1_index], str1_index);
    //     str1_index++;
    // }
    // while (!isalpha(str2[str2_index]) && (str2_index < (int)strlen(str2))) {
    ...
    //     str2_index++;
    // }
//     long int end_ind_1 = len_str1;
//     long int end_ind_2 = len_str2;

//     while (!isalpha(str1_ind_start[end_ind_1]) && (end_ind_1 > 0)) {
//         end_ind_1--;
//     }
//     while (!isalpha(str1_ind_start[end_ind_2]) && (end_ind_1 > 0)) {
//         end_ind_2--;
//     }

//     while ((len_str1 != 0) && (end_ind_2 != 0)) {
//         if (tolower(str1_ind_start[end_ind_1 - 1]) != tolower(str2_ind_start[end_ind_2 - 1])) {
//             return  tolower(str1_ind_start[end_ind_1 - 1]) - tolower(str2_ind_start[end_ind_2 - 1]);
//         }
//         end_ind_1--;
//         end_ind_2--;
//     }
